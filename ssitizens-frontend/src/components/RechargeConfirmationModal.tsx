...
const RechargeConfirmationModal: React.FC<RechargeConfirmationModalProps> = ({
  citizenName,
  amount,
  onClose
}) => {
        ...
        <div className="p-6">
          <div className="flex flex-col items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-center">
              {t("rechargeConfirmationModal.title")}
            </h2>
          </div>
          
          <div className="mb-6 text-center">
            <p className="mb-4">
              {t("rechargeConfirmationModal.message", {
                amount: amount.toFixed(2),
                citizenName
              })}
            </p>
            <p>
              {t("rechargeConfirmationModal.success")}
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <button 
              ...
              onClick={onClose}
            >
              {t("rechargeConfirmationModal.accept")}
            </button>
          </div>
        </div>
      </div>
