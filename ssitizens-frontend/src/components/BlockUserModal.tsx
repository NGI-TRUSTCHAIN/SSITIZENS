...
const BlockUserModal: React.FC<BlockUserModalProps> = ({ userName, onConfirm, onCancel }) => {
			...
			<div className='bg-white rounded-lg max-w-md w-full mx-4' onClick={(e) => e.stopPropagation()}>
				<div className='p-6'>
					<div className='flex flex-col items-center mb-6'>
						...
						<h2 className='text-2xl font-bold text-center'>{t("citizens.blockedCitizen")}</h2>
					</div>

					<div className='mb-6 text-center'>
						<p className='mb-4'>
							{t("citizens.blockConfirm", {
								userName: userName,
							})}
						</p>
						<p>{t("citizens.blockWarning")}</p>
					</div>
